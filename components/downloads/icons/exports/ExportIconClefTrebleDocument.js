...
import IconMusicClefTreble from "./ExportIconMusicClefTreble"
import ExportIconDocumentsTwo from "./ExportIconDocumentsTwo"





const ExportIconClefTrebleDocument = () => {
                            ...
                            <div className="mt-3">
                                <div className="relative scale-80">
                                    <div className="absolute">
                                        <ExportIconDocumentsTwo className="" />
                                    </div>
...
export default ExportIconClefTrebleDocument;